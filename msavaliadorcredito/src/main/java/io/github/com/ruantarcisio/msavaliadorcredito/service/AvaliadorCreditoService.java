...
public class AvaliadorCreditoService {
	...
	public String solicitarEmissaoCartao(SolicitacaoEmissaoCartaoEvent event){


		String routingKey = "mscartoes.emissao-cartao";
//		SolicitacaoEmissaoCartaoEvent event = new SolicitacaoEmissaoCartaoEvent(medalDto.getCountryName(), medalDto.getCountryCode(), medalDto.getType(), medalDto.getSportName());
